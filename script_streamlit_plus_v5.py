...
def compare_global_local(selected_data, shap_values_local):
    ...
    st.markdown("<div style='color: grey;'>The following graph compares the magnitude of feature importance at two levels: global (for all clients) and local (for a specific client).</div>", unsafe_allow_html=True)
