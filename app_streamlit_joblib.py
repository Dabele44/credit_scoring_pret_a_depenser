...
# Fonction pour afficher les explications SHAP de la classe 1
def display_shap_values(model, input_data):
    ...
    # shap.initjs()
    plt.figure(figsize=(25, 10))  # Augmentation de la taille de la figure
    ...
    st.pyplot(plt, clear_figure=True)  # Ajustement de la taille de l'affichage
...
if input_method == 'Selectbox' or (input_method == 'Text Input' and selected_id.isdigit()):
    ...
    if selected_id in test_data['SK_ID_CURR'].values:
        ...
        # Génération des prédictions pour l'individu sélectionné
        ...
        # Affichage des explications SHAP pour l'individu sélectionné
